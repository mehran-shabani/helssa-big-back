...
class OTPVerification(models.Model):
    ...
    def __str__(self):
        """
        نمایش رشته‌ای انسانی برای نمونه‌ی OTPVerification.
        
        مقدار بازگشتی شامل شماره‌ی تلفن مرتبط از طریق `otp_request` و زمان تأیید (`verified_at`) است، به صورت: `"Verification {phone_number} - {verified_at}"`. این خروجی برای نمایش در پنل ادمین، لاگ‌ها و مکان‌هایی که نیاز به نمایش خلاصه‌ای از تأیید است استفاده می‌شود.
        """
...
class TokenBlacklist(models.Model):
    ...
    def __str__(self):
        ...
        Returns:
            str: رشته نمایشی حاوی نوع توکن و کاربر مربوطه.
        """
